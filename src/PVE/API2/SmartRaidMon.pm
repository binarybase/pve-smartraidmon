    ...
    returns => {
        ...
        items => {
            ...
            properties => {
                ...
                box            => { type => 'string', optional => 1 },
                array          => { type => 'string', optional => 1 },
                status         => { type => 'string', optional => 1 },
                interface_type => { type => 'string', optional => 1 },
                drive_type     => { type => 'string', optional => 1 },
